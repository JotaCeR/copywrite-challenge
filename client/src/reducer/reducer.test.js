import currentReducer, { search, clean as currentClean } from './currentSlice'
import historyReducer, { add, remove } from './historySlice'
import lastReducer, { update, clean as lastClean } from './lastSlice'
